...
####################################
#Layout of the nodes on the chassis#
####################################
...
all_nodes = [a_l,b_l,c_l,d_l,e_l,f_l,g_l,h_l,i_l,j_l,k_l,l_l,z_l, a_r,b_r,c_r,d_r,e_r,f_r,g_r,h_r,i_r,j_r,k_r,l_r,z_r]
...
for sub_node in all_nodes:
    node_dictionary[str(sub_node)] = sub_node
